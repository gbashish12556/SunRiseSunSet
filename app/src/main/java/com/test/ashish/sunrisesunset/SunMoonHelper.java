...
//  }
    ...
    /**
     * Construct a new <code>SunMoonHelper</code> object that is initialized to
     * the current date and time.
     * @internal
     */
    public SunMoonHelper() {
     ...
     * @internal
     */
    public SunMoonHelper(long aTime) {
        time = aTime;
    }

    /**
     * Construct a new <code>SunMoonHelper</code> object with the given
     ...
     * @internal
     */
    public SunMoonHelper(double longitude, double latitude) {
        this();
    ...
    /**
     * Set the current date and time of this <code>SunMoonHelper</code> object.  All
    ...
    /**
     * Get the current time of this <code>SunMoonHelper</code> object,
...
//    }
                             ...
                             double periodDays, long epsilon, boolean next)
    {
        ...
        do {
            ...
            // to diverge:
            // SunMoonHelper.timeOfAngle() diverging: 1.348508727575625E9 ->
     ...
     *
     * @see SunMoonHelper.Equatorial
     * @see SunMoonHelper.Horizon
     * @internal
     */
